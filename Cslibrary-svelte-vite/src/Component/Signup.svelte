<script>
  ...
  const handleSubmit = async () => {
      try{
          // check if inputs field are empty
          if (!email || !username || !password || !confirmpassword) {
            StatusMessage = 'All fiedls are required';
            return;
          }
      ...
      <div class="w-1/2 p-8">
          ...
          <form on:submit|preventDefault={handleSubmit}>
              <div class="mb-4">
                  ...
                  <input type="text" id="email" bind:value={email} placeholder="example@gmail.com" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
              </div>
              <div class="mb-4">
                  <label for="username" class="block text-gray-700 text-sm font-bold mb-2">Username</label>
                  <input type="text" id="username" bind:value={username} placeholder="Enter your username" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
              </div>
              <div class="mb-6">
              ...
              <div class="mb-6">
                  ...
                  <input type="password" id="confirmpassword" bind:value={confirmpassword} placeholder="Re-Enter your password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
              </div>
